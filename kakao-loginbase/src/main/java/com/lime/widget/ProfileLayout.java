...
import com.lime.template.loginbase.GlobalApplication;
...
public class ProfileLayout extends FrameLayout {
    ...
    protected void onAttachedToWindow () {
        ...
        View view = inflate(getContext(), com.lime.template.loginbase.R.layout.kakao_profile_layout, this);

        profile = (NetworkImageView) view.findViewById(com.lime.template.loginbase.R.id.com_kakao_profile_image);
        if (profileImageURL != null)
            setProfileURL(profileImageURL);
        if (!editable) {
            ImageView editableMark = (ImageView) view.findViewById(com.lime.template.loginbase.R.id.profile_edit);
            editableMark.setVisibility(View.INVISIBLE);
        }

        nicknameText = (EditText) view.findViewById(com.lime.template.loginbase.R.id.com_kakao_profile_nickname);
        if (!editable) {
            ...
            nicknameText.setTextColor(getResources().getColor(com.lime.template.loginbase.R.color.com_kakao_profile_text));
        }
        if (nickname != null)
            nicknameText.setText(nickname);

        userIdText = (TextView) view.findViewById(com.lime.template.loginbase.R.id.com_kakao_profile_userId);
        if (userId != null)
            userIdText.setText(userId);
    }
